...
public class CharacterData {
    ...
    public static Weapon weapon2 = SpriteGenerator.weaponGenerator(1);
    ...
    public static void setWeapon2(Weapon weapon2) {
        CharacterData.weapon2 = weapon2;
    }
