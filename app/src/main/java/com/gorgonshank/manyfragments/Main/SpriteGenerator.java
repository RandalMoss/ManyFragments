...
//            return characterGenerator(characterPos);
    ...
    public static void initDrawables(Resources r, int drawableWidth, int drawableHeight){
        ...
        drawable = r.getDrawable(R.drawable.shield1);
        Armor armor7 = new Armor(r, drawable, "Wooden Shield", drawableWidth, drawableHeight);
        armors.add(armor7);
...
//        EnemyData boss1 = new EnemyData(r, drawable, "Rel\'kan", drawableWidth, drawableHeight);
//        enemies.add(boss1);
